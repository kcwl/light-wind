...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	else
	{
		...
		swapChainDesc.SwapEffect = DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL;	// 所有 Microsoft Store 应用都必须使用此 SwapEffect。
	...
	// 建议将灰度文本抗锯齿用于所有 Microsoft Store 应用。
