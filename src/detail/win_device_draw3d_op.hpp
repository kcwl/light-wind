...
namespace light_wind
{
	...
	class win_device_draw3d_op : public boost::asio::detail::operation
	{
	public:
		BOOST_ASIO_DEFINE_HANDLER_PTR(win_device_draw3d_op);

		win_device_draw3d_op(Handler& handler, const IoExecutor& io)
			: boost::asio::detail::operation(&win_device_draw3d_op::do_complete)
	...
	public:
								...
								const boost::system::error_code& result_ec, std::size_t)
		{
			...
			win_device_draw3d_op* o(static_cast<win_device_draw3d_op*>(base));
			...
			boost::asio::detail::binder1<Handler, boost::system::error_code> handler(o->handler_, ec);
